...
<div>
    <form class="needs-validation" action="index.php?menuop=inserir-tarefa" method="post" novalidate>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="descricaoTarefa" id="descricaoTarefa" cols="30" rows="10" required></textarea>
         </div>
        ...
        <div class="row">
            ...
            <label class="form-label" for="dataConclusaoTarefa">Data de Conclusão</label>
                <div class="input-group">
                    ...
                    <input class="form-control" type="date" name="dataConclusaoTarefa" required>
                </div>
            ...
            <div class="mb-3 col-12 col-sm-3">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="time" name="horaConclusaoTarefa" required>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <label class="form-label" for="dataLembreteTarefa">Data de Lembrete</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="bi bi-calendar"></i></span>
                    <input class="form-control" type="date" name="dataLembreteTarefa" required>
                </div>
            ...
            <div class="mb-3 col-12 col-sm-3">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="bi bi-wach"></i></span>
                    <input class="form-control" type="time" name="horaLembreteTarefa" required>
                </div>
            </div>
        </div>
